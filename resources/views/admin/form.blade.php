                    ...
                    <div class="card-body card-block">
                        ...
                        <form action="{{route('update',$Admin->id)}}" method="POST">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="date" id="tanggal" name="tanggal" placeholder="Text" class="form-control"  value="{{$Admin->tanggal}}" ></div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="text-input" class=" form-control-label">Jam</label></div>
                                <div class="col-12 col-md-9"><input type="text" id="waktu" name="waktu"  class="form-control" value="{{$Admin->waktu}}"></div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="text-input" class=" form-control-label">Lokasi Yang Dituju</label></div>
                                <div class="col-12 col-md-9"><input type="text" id="lokasi" name="lokasi"  class="form-control" value="{{$Admin->lokasi}}"></div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="disabled-input" class=" form-control-label">Suhu Tubuh</label></div>
                                <div class="col-12 col-md-9"><input type="text" id="suhu_tubuh" name="suhu_tubuh"  class="form-control" value="{{$Admin->suhu_tubuh}}"></div>
                            </div>             
